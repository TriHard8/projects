...
print("tail -n +1 /home/trihard8/repo/projects/tennis/lineups/{0}/{1}/{1}_{0}_lineups_0.csv | head -n -4  >> /home/trihard8/repo/projects/tennis/lineups/{0}/{1}/{1}_{0}_lineups.csv\necho >> /home/trihard8/repo/projects/tennis/lineups/{0}/{1}/{1}_{0}_lineups.csv".format(sport, date))
