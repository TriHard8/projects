...
for i in range(2,3):
    print("/home/trihard8/repo/projects/tennis/src/lineups {0} fanduel {2} $1 > /home/trihard8/repo/projects/tennis/lineups/{2}/{1}/{1}_{2}_lineups_{0}.csv".format(i, date, sport))
