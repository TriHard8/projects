...
#print("cat /home/trihard8/repo/projects/tennis/lineups/{0}/{1}/{1}_{0}_lineups_0.csv | sort --field-separator=',' --key=8 >> /home/trihard8/repo/projects/tennis/lineups/{0}/{1}/{1}_{0}_lineups.csv\necho >> /home/trihard8/repo/projects/tennis/lineups/{0}/{1}/{1}_{0}_lineups.csv".format(sport, date))

#for i in range(0, len(names)):
#    print("grep \"{1}\" /home/trihard8/repo/projects/tennis/lineups/{0}/{2}/{2}_{0}_lineups_1.csv | sort --field-separator=',' --key=8 >> /home/trihard8/repo/projects/tennis/lineups/{0}/{2}/{2}_{0}_lineups.csv\necho >> /home/trihard8/repo/projects/tennis/lineups/{0}/{2}/{2}_{0}_lineups.csv".format(sport, names[i], date))

for i in range(0, len(names)-1):
    for j in range(i+1, len(names)):
        print("grep \"{1}\" /home/trihard8/repo/projects/tennis/lineups/{0}/{3}/{3}_{0}_lineups_2.csv | grep \"{2}\" | sort --field-separator=',' --key=8 >> /home/trihard8/repo/projects/tennis/lineups/{0}/{3}/{3}_{0}_lineups.csv\necho >> /home/trihard8/repo/projects/tennis/lineups/{0}/{3}/{3}_{0}_lineups.csv".format(sport, names[i], names[j], date))

#for i in range(0, len(names)-2):
#    for j in range(i+1, len(names)-1):
#        for k in range(j+1, len(names)):
#            print("grep \"{1}\" /home/trihard8/repo/projects/tennis/lineups/{0}/{4}/{4}_{0}_lineups_3.csv | grep \"{2}\" | grep \"{3}\" | sort --field-separator=',' --key=8 >> /home/trihard8/repo/projects/tennis/lineups/{0}/{4}/{4}_{0}_lineups.csv\necho >> /home/trihard8/repo/projects/tennis/lineups/{0}/{4}/{4}_{0}_lineups.csv".format(sport, names[i], names[j], names[k], date))
#
